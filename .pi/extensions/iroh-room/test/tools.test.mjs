...
test("index.ts entry registers 10 tools + 8 commands + a session_shutdown handler", async () => {
	const pi = stubPi();
	entry.default(pi);
...
test("registerIrohCommands registers the 8 contract commands (COMMAND_NAMES lockstep)", () => {
