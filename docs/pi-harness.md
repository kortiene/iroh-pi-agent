...
| `/room-cockpit [open\|overlay\|close\|refresh\|tab <overview\|timeline\|tasks\|members\|artifacts\|pipes\|health>]` | Open the read-only room cockpit in TUI mode; `overlay` opens it as a right-side overlay. |
